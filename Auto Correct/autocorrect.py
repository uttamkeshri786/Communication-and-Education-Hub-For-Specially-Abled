...
class autocorrect:
    ...
    def fix_text(self):
        ...
        self.sentence = self.dict.suggest(self.string) #permutations + predictions
        self.comparision = {} #key:value key : min-edit value : string
        self.predict2()
        self.display()
    ...
    def predict2(self):
        '''
            ...
            Return : None
        '''
        for i in self.sentence: #i predicted, self.string : inserted wala
